...
const uploads = [
  { 
    title: 'മീലാദ് @ 1500 campaign inauguration ', 
    ...
    views: '',
    uploadDate: '',
    description: `മിലാദ് @ 1500 🌹ക്യാമ്പയിൻ പ്രഖ്യാപനം 
                  10 08 2025 ഞായർ 4pm
                  ശൈഖ് ജിലാനി ഇസ്ലാമിക് അക്കാദമി മങ്കേരി 
                  Jeelani Studies Center
                  Valanchery`,
    category: 'Spiritual'
  },
  { 
    title: 'ഖുതുബുസ്സമാൻ അനുപമ വ്യക്തിത്വം : ശൈഖ് മുഹമ്മദ്‌ അബ്ദുറഹീം മുസ് ലിയാർ വളപുരം', 
    ...
    views: '',
    uploadDate: '',
    description: 'ഖുതുബുസ്സമാൻ അനുപമ വ്യക്തിത്വം :  ശൈഖ് മുഹമ്മദ്‌ അബ്ദുറഹീം മുസ് ലിയാർ വളപുരം',
    category: 'Islamic,Spiritual'
  },
  { 
    title: 'തിരുനബി(സ്വ)യുടെ ഫോട്ടോ ഹിർഖൽ രാജാവിൻറെ കൊട്ടാരത്തിൽ-ശൈഖ് ഫസ്‌ലു ള്ള ഫൈസി വലിയോറ', 
    ...
    views: '',
    uploadDate: '',
    description: 'തിരുനബി(സ്വ)യുടെ ഫോട്ടോ ഹിർഖൽ രാജാവിൻറെ കൊട്ടാരത്തിൽ| മീലാദ് സമ്മേളനം | ശൈഖ് ഫസ്‌ലു ള്ള ഫൈസി വലിയോറ',
    category: 'Islamic'
  },
  { 
    title: 'തൗഹീദിന്റ പ്രാധാന്യം | സയ്യിദ് അബ്ദുൽ ഖാദിർ ഖാദിരി അൽ ബുഖാരി', 
